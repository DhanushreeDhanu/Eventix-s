...
if (isset($_POST['update_event'])) {
    ...
    $update = $conn->prepare("UPDATE events SET 
        event_name=?, event_type=?, event_date=?, event_time=?, venue=?, google_map_link=?,
        required_volunteers=?, capacity=?, volunteer_payment=?, payment_timeline=?, payment_method=?,
        volunteer_duties=?, instructions=?, description=?, status=?
            ...
            <style>
                body {
                    ...
                    background:
                        ...
                        radial-gradient(circle at bottom right, rgba(34,211,238,.20), transparent 30%),
    ...
    <div class="container">
        <div class="row main-card">
            ...
            <div class="col-lg-4 left-panel">
                ...
                <p>
                    Update event information, volunteer requirements, payment rules,
                    location, instructions, and automatic event status.
                </p>
            ...
            <div class="col-lg-8 form-panel">
                ...
                <p class="text-center text-muted mb-4">
                    Update details carefully before saving changes
                </p>
                ...
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url"
                               ...
                               class="form-control"
                               value="<?php echo htmlspecialchars($event['google_map_link'] ?? ''); ?>">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number"
                                   ...
                                   class="form-control"
                                   value="<?php echo htmlspecialchars($event['required_volunteers']); ?>"
                                   required>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number"
                                   ...
                                   class="form-control"
                                   value="<?php echo htmlspecialchars($event['volunteer_payment'] ?? 0); ?>"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="volunteer_duties" class="form-control" required><?php echo htmlspecialchars($event['volunteer_duties'] ?? ''); ?></textarea>
                    </div>

                    <div class="mb-3">
                        <label>Special Instructions</label>
                        <textarea name="instructions" class="form-control" required><?php echo htmlspecialchars($event['instructions'] ?? ''); ?></textarea>
                    </div>
                    ...
                    <h5 class="section-heading">Event Status</h5>

                    <div class="status-note">
                        <strong>Auto Status:</strong>
                        Past event date becomes Completed. Today/future event date stays Upcoming.
                    </div>

                    <div class="mb-4">
                        <label>Cancel Event</label>
                        <select name="manual_cancel" class="form-select">
                            <option value="no">Do not cancel</option>
                            <option value="yes">Cancel this event</option>
                        </select>
                    </div>
